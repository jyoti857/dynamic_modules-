...
export const EDIT_CNX_MODAL = '@DYNAMIC/EDIT_CNX_MODAL';
export const EDIT_CNX_FORM = '@DYNAMIC/EDIT_CNX_FORM';
export const EDIT_IND_CONEXION = '@DYNAMIC/EDIT_IND_CONEXION';
